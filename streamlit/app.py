...
<p style='color:#888; margin-top:4px; font-size:14px'>
  End-to-End AI Data Engineering Pipeline · Databricks + Delta Lake + Claude AI
</p>
...
with tab3:
    ...
    with col2:
        st.subheader("Mood Distribution (Claude AI)")
    ...
    st.subheader("Target Audience Split (Claude AI Enrichment)")
...
with tab4:
    st.subheader("Strategic Insights — Generated by Claude AI")
